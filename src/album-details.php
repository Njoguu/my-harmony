...
if (isset($_GET['id'])) {
    ...
    // Fetch songs
    $result = $db->query("SELECT * FROM songs WHERE album_id=$id");
...
<head>
    ...
    <title><?php echo $album['title']; ?> | My Harmony</title>
...
<div class="landing-page">
        <header id="navbar">
            <div class="container">
                ...
                <ul class="links">
                    <a href="#songs"><li>Browse Songs</li></a>
                </ul>
            </div>
        </header>
    ...
    <section id="songs" class="details container">
        ...
        <h4>Release Year: <?php echo $album['release_year']; ?></h4>
        <h3>Songs</h3>
